  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: false,
        elevation: 0,
        backgroundColor: Colors.red,//Color(0xFF00BF6D),
      ...
      children: [
        ...
        ...List.generate(
          demoContactsImage.length,
            ...
            title: const Text("Jenny Wilson"), //Nombre de la clase usuario??
            onTap: () {}, //Que abra el chat con ese usuario con sus datos (?)
          ),
        ),
      ],
    );
